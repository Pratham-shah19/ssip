        ...
        <Suspense fallback="Login is Loading">
          <Routes>
            <Route path="/">
              ...
              <Route path="/otp" element={<_OTP />} />
              <Route
                path="/owner-dashboard/add-qty"
                element={<_AddQuantity />}
              />
              <Route path="/forget-email" element={<_ForgetEmail />} />
              <Route path="/forget-password" element={<_NewPassword />} />
              <Route path="/otp_ow" element={<_OTP_Ow />} />
              <Route path="/forget-email_ow" element={<_ForgetEmail_Ow />} />
              <Route path="/forget-password_ow" element={<_NewPassword_Ow />} />
              <Route path="admin-dashboard" element={<_AdminDashboard />} />
              <Route
                path="admin-dashboard/transaction"
                element={<_AdminTransaction />}
              />
              <Route
                path="admin-dashboard/register"
                element={<_AdminRegister />}
              />
              <Route
                path="admin-dashboard/profile"
                element={<_AdminProfile />}
              />
              <Route path="owner-dashboard" element={<_HomeOwnerDashboard />} />
              <Route path="owner-history" element={<_OwnerHistory />} />
              <Route
                path="owner-dashboard/orders"
                element={<_OrdersOwnerDashboard />}
              />
              <Route
                path="owner-dashboard/menu"
                element={<_MenuOwnerDashboard />}
              />
              <Route
                path="owner-dashboard/menu/add-item"
                element={<_AddItemOwner />}
              />
              <Route
                path="owner-dashboard/confirmOrder"
                element={<_ConfirmOrder />}
              />{" "}
              <Route
                path="owner-dashboard/wallet"
                element={<_WalletOwnerDashboard />}
              />
              <Route
                path="owner-dashboard/profileScreen"
                element={<_Owner_ProfileScreen />}
              />
              <Route
                path="owner-dashboard/unknown"
                element={<_UnknownScreen />}
              />

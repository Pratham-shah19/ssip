...
const Summary = () => {
    ...
    return(
        <div className='sum_cart_handler'>
            ...
            <hr />
            {cartItems.length > 0 ? <div className="Sub_total">
                <p className='Sub_total_text'>Subtotal : {cartTotalAmount}</p>
                <p className='Sub_total_text_GST'>GST(18%) : {Math.round(cartTotalAmount*0.18)}</p>
                <hr />
                <p className='Sub_total_text_TOTAL'>Total : {cartTotalAmount + Math.round(cartTotalAmount*0.18)}₹</p>
            </div> : <p></p>}
        </div>

...
const SubscriptionProductitems = ({dish}) => {
  ...
  const totalPrice = dish.price * 30;
  ...
  return (
    <>
      <Pressable
        ...
        <View style={{flex: 1, marginTop: 16, marginRight: 10}}>
          <ImageBackground
            source={{
              uri: dish?.imageUrl,
            }}
            ...
            <View style={{backgroundColor: 'white'}}>
              ...
              <TouchableOpacity
                ...
                <Text
                  ...
                  Buy Subscription for Rs.{totalPrice}
                </Text>
              </TouchableOpacity>
              <Text
                style={{
                ...
                *Note : You can redeem these dishes from canteen at anytime
              </Text>
            </View>
          </View>
        </View>
...
export default SubscriptionProductitems;

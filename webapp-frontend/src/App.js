      ...
      <Router>
        <Routes>
          <Route path="/">
            ...
            <Route path="admin-dashboard/transaction" element={<AdminTransaction/>} />
            ...
            {/* Annonymus */}
            <Route path="owner-dashboard/orders" element={<OrdersOwnerDashboard/>} />

            {/*Menu Screen 2nd*/}
            <Route path="owner-dashboard/menu" element={<MenuOwnerDashboard/>} />

            {/* Adding New Item */}
            <Route path="owner-dashboard/menu/add-item" element={<AddItemOwner/>} />

            <Route path="owner-dashboard/confirmOrder" element={<ConfirmOrder />} />

            <Route path="owner-dashboard/wallet" element={<WalletOwnerDashboard/>} />
          </Route>
        </Routes>
      </Router>
    </div>

...
const CollapsibleBox = ({orderId,otp,cust_name,item_arr,_button}) => {
    ...
    const labels = () => {
        ...
        const completedHandler = async () => {
            const completedButton = await axios.post(`http://127.0.0.1:4000/api/v1/canteen/guestcompletedbutton/${orderId}`,{},{
        ...
        const conditional_render = () => {
            if(cust_name !== 'Guest'){
                return(
                    ...
                    <div type="button" className="completed1" onClick={completedHandler()}>
            ...
            <div className="competed">
            <button type="button" className="completed1" onClick={completedHandler()}>
        ...
        <Collapsible 
            ...
            trigger={
                <div className="box">
                    ...
                    <div className="btn">
                    <button className="toggle" onClick={toggle}>{<ArrowDropDownCircleIcon sx={{ fontSize: 40}} />} </button>
                    </div>
                </div>
            }
        >

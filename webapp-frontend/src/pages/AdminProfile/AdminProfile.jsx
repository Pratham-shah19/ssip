          ...
          <div className="profile-container">
            <div className="profile-left">
                <div className="profile-pic">
                    <img src="https://www.cmcaindia.org/wp-content/uploads/2015/11/default-profile-picture-gmail-2.png" alt="" />
                </div>
                <div className="profile-btns">
                    <input type="button" value="CHANGE PHOTO" className='profile-btn' />
                    <input type="button" value="LOG OUT" className='profile-btn' />
                </div>
            </div>

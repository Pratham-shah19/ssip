...
const AdminRegister = () => {
    const clickHandler = async (e) => {  
        const obj={
          ...
          console.log(obj)
          const data = await Axios.post('http://127.0.0.1:2000/api/v1/user/register',obj)
          ...
          <div className="admin-register">
            <form name='f1'>
                ...
                <div className="form-cell">
                    ...
                    <div className="form-right">
                        <textarea  name="address" id="address" placeholder='Enter Address' required />
                    </div>
                </div>                  
                <input type="submit" value="SUBMIT" onClick={clickHandler} className='submit-btn'/>          
            </form>
          </div>
        </div>
    </div>
